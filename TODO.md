...
3. maybe instead of random motd & msgs in motd_server.lua, we can update the motd & msgs every 30secs or something, so that clients dont see difference messages every time they connect, but they will see different messages every 30secs or so.
